...
assert.equal(await page.locator('.farm-decoration-f7 img').evaluateAll(images => images.every(image => image.complete && image.naturalWidth === 1254 && image.naturalHeight === 1254)), true)
