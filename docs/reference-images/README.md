...
- 图标规则：主体、倾斜角度、表情、农场构图、圆角画面和颜色关系不可重新设计。生产图标只允许裁掉母图用于展示的外围白色画布，并按平台安全区做机械尺寸派生；不得让生成式 AI 重画。
- 当前状态：2026-07-17 已完成 180、192、512 和 512 maskable 四种生产尺寸派生；A2759 真机发现首版直接缩小母图会形成双重白边，第二版已机械裁去四边各 30px 展示留白后重新派生。输出哈希与方法登记在 [`../../public/pwa-icon-manifest.json`](../../public/pwa-icon-manifest.json)，最终显示需删除旧主屏幕图标后重新添加验证。
